...
class comunicado(models.Model):
    ...
    _description = 'Comunicados enviados a padres, alumnos y/o maestros'
    
    asunto = fields.Char(string="Asunto", required=True)
    contenido = fields.Text(string="Contenido", required=True)
    tipo_comunicado_id = fields.Many2one('agenda.tipo_comunicado', string="Tipo de Comunicado", required=True)
